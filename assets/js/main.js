...
function buttonsFilter(){
    ...
    document.getElementById("add-first-product").onclick = function() {  
        addToCart(2, 1)
    };
}
...
function showProductsCard(){
    ...
    if(cart){
        cart.forEach(product => {
            ...
            document.getElementById('cart-items').innerHTML = totalProducts
        })
    }
}
...
function showCart(){
    document.getElementById('content-cart').style.display = "flex"
}

function showMenu(){
    document.getElementById('cart-ul').style.display = "flex"
    document.getElementById('nav-menu').classList.add('wd-100')
}

function hideCart(){
    document.getElementById('content-cart').style.display = "none"
}

function hideMenu(){
    document.getElementById('cart-ul').style.display = "none"
    document.getElementById('nav-menu').classList.remove('wd-100')
}
